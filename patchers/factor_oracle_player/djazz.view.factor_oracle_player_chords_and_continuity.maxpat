...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 228.0, 69.5, 22.0 ],
									"text" : "sel 0"
								}
...
,
									"patching_rect" : [ 100.5, 172.0, 84.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 100.000020333333282, 310.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 311.666666666666686, 158.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 384.166666666666686, 282.0, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 455.666666666666686, 219.0, 57.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 369.666666666666686, 219.0, 61.0, 22.0 ],
					"text" : "hidden $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 47.0, 83.0, 416.0, 22.0 ],
					"text" : "route improvise semitone_range max_continuity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.666666666666686, 219.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.333333333333343, 219.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"pic" : "2448971-200.png",
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 1.0, 22.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.333333333333371, 348.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.666666666666686, 348.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 0.0, 40.0, 22.0 ],
					"text" : "MAX",
					"texton" : "MAX"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 0.0, 44.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 0.0, 44.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 465.166666666666686, 207.5, 379.166666666666686, 207.5 ],
					"order" : 1,
					"source" : [ "obj-4", 0 ]
				}
